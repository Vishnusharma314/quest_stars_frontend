...
function Home() {
  ...
  const handleFormSubmit = (e) => {
    ...
    setPromt(`Generate a detailed scientific report based on the following genomic mutation data: 
    Gene:${promptData.geneName ? promptData.geneName : "not applicable"},
    Mutation Type:${
    ...
    axios
      .post("https://f85f-106-222-213-162.ngrok-free.app/gemini", {
        prompt: promt.trim(),
      })
  ...
  return (
    <>
      <Header />
      <div className="mt-6 shadow-md mx-auto p-6">
          ...
          <div className="grid grid-cols-5 gap-4">
            ...
            {isResultPage && (
              <div className="col-span-4 mt-6">
                <ResultPage closeResult={handleCloseResult} />
              </div>
            )}
          </div>
